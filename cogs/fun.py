...
class Fun(commands.Cog):
    def __init__(self, bot):
        ...
        @app_commands.describe(lover1="The user you want to ship.")
        @app_commands.describe(lover2="The user you want to ship lover1 to.")
        async def ship(interaction: discord.Interaction, lover1: discord.Member, lover2: discord.Member = None):
            """Ship 2 users."""
        ...
        @app_commands.describe(comment="The comment you want to post on PornHub.")
        async def phcomment(interaction: discord.Interaction, comment: str):
